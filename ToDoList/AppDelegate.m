...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "test.asdsa" in the application's documents directory.
...
-(NSArray*)fetchReportFromDatabse{
    ...
    NSSortDescriptor *sdSerialno = [NSSortDescriptor sortDescriptorWithKey:@"serialno" ascending:NO];
    fetchRequest.sortDescriptors = @[sdSerialno];
    NSError *error = nil;
